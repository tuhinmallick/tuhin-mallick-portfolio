...
/**
 * @description Receives a request (`req`) and sends a response (`res`). It logs the
 * request method and URL to the console, then returns a JSON response with a success
 * message indicating that the API is functioning correctly.
 * 
 * @param {Request | IncomingMessage} req - Used to receive the incoming HTTP request.
 * 
 * @param {Response} res - Responsible for sending responses to HTTP requests.
 */
